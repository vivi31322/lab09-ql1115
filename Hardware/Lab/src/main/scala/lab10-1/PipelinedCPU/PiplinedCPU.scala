package lab10-1.PiplinedCPU

import chisel3._
import chisel3.util._

import lab10-1.Memory._
import lab10-1.MemIF._
import lab10-1.PiplinedCPU.StageRegister._
import lab10-1.PiplinedCPU.Controller._
import lab10-1.PiplinedCPU.DatapathModule._
import lab10-1.PiplinedCPU.DatapathModule.DatapathComponent._
...
class PiplinedCPU(memAddrWidth: Int, memDataWidth: Int) extends Module {
    ...
    val datapath_IF = Module(new Path_IF(InstAddrWidth))
    ...
    datapath_ID.io.WB_RegWEn := contorller.io.WB_RegWEn
    ...
    datapath_EXE.io.E_BrUn := Icontorller.io.E_BrUn
    ...
    // === WB stage reg ==============================================================
    stage_WB.io.Stall := ontorller.io.Hcf        // To Be Modified
    ...
    io.EXE_src1 := datapath_EXE.io.alu_src1
    io.EXE_src2 := datapath_EXE.io.alu_src1
