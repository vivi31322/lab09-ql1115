package lab10-1.PiplinedCPU.Controller

import chisel3._
import chisel3.util._

import lab10-1.PiplinedCPU.opcode_map._
import lab10-1.PiplinedCPU.condition._
import lab10-1.PiplinedCPU.inst_type._
import lab10-1.PiplinedCPU.alu_op_map._
import lab10-1.PiplinedCPU.pc_sel_map._
import lab10-1.PiplinedCPU.wb_sel_map._
import lab10-1.PiplinedCPU.forwarding_sel_map._
...
class Controller(memAddrWidth: Int) extends Module {
  ...
  io.D_ImmSel := 0.U // To Be Modified

  // Control signal - Scalar ALU
  io.E_ASel := 0.U // To Be Modified
  io.E_BSel := 0.U // To Be Modified
  ...
  Stall_DH := false.B // Stall for Data Hazard
  Stall_MA := false.B // Stall for Waiting Memory Access
